function setLanguage(lang) {
  ...
  const translations = {
    ...
    'en': {
      ...
      "chiSiamo2": "ABOUT US",
      "chiSiamo3": "Fundada en Bolonia en 1907,<br>ORSI es una de las pocas empresas italianas prominentes en el mercado de detergentes en polvo para uso doméstico e institucional.<br>Compitiendo en experiencia, tecnología y calidad con empresas líderes del sector.<br>Hoy en día, ORSI invierte en Investigación y Desarrollo para innovar en el campo de detergentes y cosméticos.",
